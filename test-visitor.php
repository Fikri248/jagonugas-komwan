<?php
// test-visitor.php - ULTRA MODERN DESIGN
session_start();
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .stat-card:nth-child(1) { --card-index: 0; }
        .stat-card:nth-child(2) { --card-index: 1; }
        .stat-card:nth-child(3) { --card-index: 2; }
        .stat-card:nth-child(4) { --card-index: 3; }
    ...
    <div class="container">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-growth <?php echo $growthPercent > 0 ? 'up' : 'down'; ?>">
                    <i class="bi bi-<?php echo $growthPercent > 0 ? 'arrow-up' : 'arrow-down'; ?>"></i>
                    <?php echo abs($growthPercent); ?>% vs yesterday
                </div>
                <?php endif; ?>
            </div>
